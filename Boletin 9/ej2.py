...
def main():
    coche1 = Consumo()
    coche1.setLitros(180)
    coche1.setPGas(3.7)
    print(f"Litros: {coche1.getLitros()} L")
    print(f"Prezo gasolina: {coche1.getPGas()} €/L")

    coche2 = Consumo(km=400, litros=30, vMed=50, pGas=1.00)

    print(f"Consumo medio: {coche2.consumoMedio():.2f} L/50 km")

    coche2.setLitros(45)
    print(f"Consumo medio tras cambiar litros: {coche2.consumoMedio():.2f} L/50 km")
